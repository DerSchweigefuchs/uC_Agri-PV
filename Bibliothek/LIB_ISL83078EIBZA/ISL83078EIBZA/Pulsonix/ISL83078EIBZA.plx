...
//1660384/1638757/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ISL83078EIBZA" (originalName "ISL83078EIBZA")
	...
	(compDef "ISL83078EIBZA" (originalName "ISL83078EIBZA") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "B/Z") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "A/Y") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ISL83078EIBZA"))
		...
		(attr "Mouser Part Number" "968-ISL83078EIBZA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Renesas-Intersil/ISL83078EIBZA?qs=dAsayXGOMrvZH4ftGSAhkg%3D%3D")
		(attr "Manufacturer_Name" "Renesas Electronics")
		(attr "Manufacturer_Part_Number" "ISL83078EIBZA")
		(attr "Description" "The Intersil ISL8307XE are BiCMOS 3. 3V powered, single transceivers that meet both the RS-485 and RS-422 standards for balanced communication. These devices have very low bus currents (+125mA/-100mA), so they present a true 1/8 unit load to the RS-485 bus. This allows up to 256 transceivers on the network without violating the RS-485 specifications 32 unit load maximum, and without using repeaters. For example, in a remote utility meter reading system, individual meter readings are routed to a concentra")
		(attr "<Hyperlink>" "https://www.renesas.com/en-us/www/doc/datasheet/isl83070e-71e-72e-73e-75e-78e.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ISL83078EIBZA.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=1.63")
